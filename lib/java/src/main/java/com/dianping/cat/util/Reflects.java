...
public class Reflects {
    ...
    public enum ResourceReflector {
        ...
        public java.util.Properties getResource(Class<?> anchorClass, String resName) {
            // step1: try to load from current class loader
            java.util.Properties prop = getResource(getClass().getClassLoader(), anchorClass, resName);
        ...
        public java.util.Properties getResource(ClassLoader classloader, Class<?> anchorClass, String resName) {
